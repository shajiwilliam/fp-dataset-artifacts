...
def main():
    ...
    if training_args.do_eval:
        ...
        adv_squad_path = os.path.join(os.getcwd(), 'adverse_data_set_squad_train_innoculation3percent.json')
    
    if args.dataset == 'combined_squad_adv_squad':
        dataset_id = 'qa'
        squad_dataset = datasets.load_dataset('squad')
        print(squad_dataset["train"])
        adv_squad_dataset = datasets.load_dataset('json', data_files=adv_squad_path,features=squad_dataset["train"].features)  
        print(adv_squad_dataset["train"])
